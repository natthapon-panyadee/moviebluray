							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									...
									<div class="ml-auto text-right">
										...
										<div class="product_price text-right"><?php echo $row['movie_price']; ?> บาท</div>
									</div>&nbsp;&nbsp;&nbsp;
									<div>
                    <h2></h2> &nbsp;
              				  	<button type="submit" name="submitNew" size="10" class="btn btn-primary btn-sm"> Edit </button> <br>
                                <a  size="10"  class="btn btn-danger btn-sm" href="structure/api_delete.php?id=<?php echo $row['movie_id']?>">Delete</a>
				...
				<div class="row page_nav_row">
					<div class="col">
						<div class="page_nav">
							...
							<div> <br>
	<a  type="button" class="btn btn-primary btn-lg btn-block" href="upload.php">Add New Movie</a>
	</div>
						</div>
					</div>
				</div>
